...
class AutoHotPy(object):
    ...
    def __init__(self):
        ...
        self.NUMERIC_1 =Key(self,0x4F,"NUMERIC_1")
        self.NUMERIC_2 =Key(self,0x50,"NUMERIC_2")
        self.NUMERIC_3 =Key(self,0x51,"NUMERIC_3")
        self.NUMERIC_4 =Key(self,0x4B,"NUMERIC_4")
        self.NUMERIC_5 =Key(self,0x4C,"NUMERIC_5")
        self.NUMERIC_6 =Key(self,0x4D,"NUMERIC_6")
        self.NUMERIC_7 =Key(self,0x47,"NUMERIC_7")
        self.NUMERIC_8 =Key(self,0x48,"NUMERIC_8")
        self.NUMERIC_9 =Key(self,0x49,"NUMERIC_9")
        ...
        self.keys[self.NUMERIC_1 .get_id()]=self.NUMERIC_1
        self.keys[self.NUMERIC_2 .get_id()]=self.NUMERIC_2
        self.keys[self.NUMERIC_3 .get_id()]=self.NUMERIC_3
        self.keys[self.NUMERIC_4 .get_id()]=self.NUMERIC_4
        self.keys[self.NUMERIC_5 .get_id()]=self.NUMERIC_5
        self.keys[self.NUMERIC_6 .get_id()]=self.NUMERIC_6
        self.keys[self.NUMERIC_7 .get_id()]=self.NUMERIC_7
        self.keys[self.NUMERIC_8 .get_id()]=self.NUMERIC_8
        self.keys[self.NUMERIC_9 .get_id()]=self.NUMERIC_9
...
#            print("#####DEVICE ID:"+str(device))
    ...
    def mouse_move(self, x, y):
        startX, startY = self.getMousePosition()
